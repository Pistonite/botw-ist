...
export type SettingFunction = <T extends keyof StoreSetting>(
    key: T,
    value?: StoreSetting[T],
) => StoreSetting[T];
...
export const StoreProvider: React.FC<PropsWithChildren> = ({ children }) => {
    ...
    const settingFunction: SettingFunction = useCallback(
        (key, value) => {
            if (value !== undefined) {
    ...
    const [commandData, setCommandData] = useState<string[]>(
        loadOrDefault(KEY_COMMAND_DATA, DefaultCommands),
    );
