...
describe("core/command/parse.add", () => {
    ...
    it("parses single item", () => {
        expect("get Mat eri al A").toParseIntoCommand(
            mockSearchItem,
            new CommandAdd(
    ...
    it("parses list of items", () => {
        expect("buy 1 Material A 2 Material B 3 Material C").toParseIntoCommand(
            mockSearchItem,
            new CommandAdd(
                [
                    new ItemStackArg(MockItems.materiala.defaultStack, 1),
    ...
    it("parses list of items with meta", () => {
        expect(
            "add 1 Material A 2 Material B 1 weapon1 [equip]",
        ).toParseIntoCommand(
            mockSearchItem,
            new CommandAdd(
                [
    ...
    it("parses repeated as separate slots", () => {
        expect("cook 2 materialb 2 materialb").toParseIntoCommand(
            mockSearchItem,
            new CommandAdd(
                [
                    new ItemStackArg(MockItems.materialb.defaultStack, 2),
    ...
    it("parses pickup verb", () => {
        expect("pickup 2 materialb 2 materialb").toParseIntoCommand(
            mockSearchItem,
            new CommandAdd(
                [
                    new ItemStackArg(MockItems.materialb.defaultStack, 2),
    ...
    it("parses pick up verb", () => {
        expect("pick up 2 materialb 2 materialb").toParseIntoCommand(
            mockSearchItem,
            new CommandAdd(
                [
                    new ItemStackArg(MockItems.materialb.defaultStack, 2),
