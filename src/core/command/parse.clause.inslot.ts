...
import { ASTArgumentSingleItemMaybeInSlot, ASTArgumentSingleItemMaybeInSlotAIdentifier, ASTArgumentSingleItemMaybeInSlotAIdentifierC2, isClauseInSlot, isEpsilon } from "./ast";
...
const parseASTArgumentSingleItemMaybeInSlotAIdentifier:
    Parser<ASTArgumentSingleItemMaybeInSlotAIdentifier, [string[], number]>
= (ast) => {
    if(isEpsilon(ast)){
        return [
            [[], 1/* default slot */],
