        ...
        <Page title="Setting">
            <Category title="Layout">
                ...
                <Label>
                    {settingToString(
                        showSaves,
                        "Always showing saves",
                        "Don't show saves",
                        "Show when more than 1 save",
                    )}
                </Label>
                <Description>
                ...
                <Label>
                    {settingToString(
                        showGameData,
                        "Always showing Game Data",
                        "Don't show Game Data",
                        "Show when Game Data is desynced",
                    )}
                </Label>
                <Description>
                ...
                <Control disabled={showGameData === false}>
                    ...
                    <Description className="Primary">
                        Toggle if Game Data should be interlaced with Visible
                        Inventory.
                    </Description>
                    <Description>
                        When they are interlaced, you could see how the slots
                        correspond during an Inventory Corruption. (Has no
                        effect if Game Data Panel is hidden.)
                    </Description>
                </Control>
            </Category>
            <Category title="Items">
                <Button
                    className="Small"
                    onClick={() => setting("animatedIcon", !isIconAnimated)}
                >
            ...
            <Category title="Commands">
                <Button
                    className="Small"
                    onClick={() => setting("showCommandHint", !showHint)}
                >
                ...
                <Label>
                    {settingToString(
                        showHint,
                        "Show command hints",
                        "Do not show command hints",
                    )}
                </Label>
                <Description>
                    Toggle if the simulator should guess which command you are
                    trying to use, and show the usage info. (Will still show
                    errors)
                </Description>
            </Category>
            <Category title="Advanced">
                <Control disabled>
                    ...
                    <Description>
                        Enable editing of all commands. Some commands are
                        simplified for non-advanced users and are read-only
                        unless in superuser mode
                    </Description>
                </Control>
            </Category>

            <Button className="Full" onClick={() => setPage("#simulation")}>
                Close
            </Button>
        </Page>
    );
