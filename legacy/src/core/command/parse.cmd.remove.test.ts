...
describe("core/command/parse.remove", () => {
    ...
    it("remove single item", () => {
        expect("remove material a").toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
    ...
    it("remove 1 item stack", () => {
        expect("remove 100 material b").toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
    ...
    it("remove 1 all item stack", () => {
        expect("dnp all materialc").toParseIntoCommand(
            mockSearchItem,
            new CommandDnp(
    ...
    it("remove multiple item stacks", () => {
        expect("drop 2 material c 3 material b").toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
                [
    ...
    it("remove multiple item stacks with all", () => {
        expect("eat all materialc 3 material b").toParseIntoCommand(
            mockSearchItem,
            new CommandEat(
                [
                    new ItemStackArg(MockItems.materialc.defaultStack, "All"),
    ...
    it("remove multiple item stacks with multiple all", () => {
        expect("remove all materialc all material b").toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
                [
                    new ItemStackArg(MockItems.materialc.defaultStack, "All"),
    ...
    it("remove multiple item stacks with all and meta", () => {
        expect(
            "sell all materialc 3 materialb[equip, life=700]",
        ).toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
                [
...
describe("core/command/parse.remove from", () => {
    ...
    const mockSearchItem = createMockItemSearch(MockItems);
    it("remove single item", () => {
        expect("remove materiala from slot 3").toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
                [new ItemStackArg(MockItems.materiala.defaultStack, 1)],
                3,
    ...
    it("eat 1 item stack", () => {
        expect("eat 100 materialb from slots 9").toParseIntoCommand(
            mockSearchItem,
            new CommandEat(
                [new ItemStackArg(MockItems.materialb.defaultStack, 100)],
                9,
    ...
    it("remove 1 all item stack", () => {
        expect("sell all materialc from slot 8").toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
                [new ItemStackArg(MockItems.materialc.defaultStack, "All")],
                8,
    ...
    it("remove multiple item stacks", () => {
        expect("drop 2 materialc 3 material b from slot 7").toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
                [
                    new ItemStackArg(MockItems.materialc.defaultStack, 2),
    ...
    it("remove multiple item stacks with all", () => {
        expect(
            "remove all materialc 3 material b from slot 6",
        ).toParseIntoCommand(
            mockSearchItem,
            new CommandRemove(
                [
    ...
    it("dnp multiple item stacks with all and meta", () => {
        expect(
            "dnp all materialc[life: 666] 3 materialb[equip, life=700] from slot 8",
        ).toParseIntoCommand(
            mockSearchItem,
            new CommandDnp(
                [
...
describe("core/command/parse.remove all", () => {
    it.each([
        ...
        [
            "armor",
            [ItemType.ArmorLower, ItemType.ArmorMiddle, ItemType.ArmorUpper],
        ],
        ["material", [ItemType.Material]],
        ["food", [ItemType.Food]],
        ["key item", [ItemType.Key]],
    ])("remove all types", (typeString, expectedTypes) => {
        expect(`remove all ${typeString}`).toParseIntoCommand(
            undefined,
            new CommandRemoveAll(expectedTypes, []),
        );
        expect(`remove all ${typeString}s`).toParseIntoCommand(
            undefined,
            new CommandRemoveAll(expectedTypes, []),
        );
    });
