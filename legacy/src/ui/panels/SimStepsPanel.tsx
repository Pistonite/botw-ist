...
export const SimStepsPanel: React.FC<SimStepsPanelProps> = ({
    ...
    const { commandData, setPage, setCommandData, editing, setWarnReadOnly } =
        useRuntime();
