...
export const createEquipmentStack = (
    item: Item,
    durability: number,
    equipped: boolean,
): ItemStack => {
...
export const createArrowMockItem = (id: string): Item =>
    new MockItem(id, ItemType.Arrow, true, true);
export const createMaterialMockItem = (id: string): Item =>
    new MockItem(id, ItemType.Material, true, true);
export const createFoodMockItem = (id: string): Item =>
    new MockItem(id, ItemType.Food, false, true);
export const createFoodMockItemStackable = (id: string): Item =>
    new MockItem(id, ItemType.Food, true, true);
export const createKeyMockItem = (id: string): Item =>
    new MockItem(id, ItemType.Key, false, false);
export const createKeyMockItemStackable = (id: string): Item =>
    new MockItem(id, ItemType.Key, true, true);
export const createEquipmentMockItem = (id: string, type: ItemType): Item =>
    new MockItem(id, type, false, id !== "MasterSword");

export const equalsExceptEquip = (a: ItemStack, b: ItemStack): boolean =>
    a.equalsExcept(b, "equipped");
...
export const createMockItemSearch =
    (items: Record<string, Item>) =>
    (id: string): ItemStack | undefined => {
