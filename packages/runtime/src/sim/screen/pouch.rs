...
impl PouchScreen {
    ...
    /// the other states
    pub fn update_all_items(&mut self, cpu2: &mut Cpu2<'_, '_>, force_accessible: bool) -> Result<(), memory::Error> {
...
fn do_open(cpu2: &mut Cpu2<'_, '_>, force_accessible: bool) -> Result<sim::ScreenItems, memory::Error> {
