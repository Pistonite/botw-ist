...
game: (Running)
  ...
  pouch: (count=5, are_tabs_valid=true, num_tabs=3, holding_in_inventory=false, trial=false, )
    ...
    tabs: (len=3, )
      ...
      [02]: (item_idx=3, tab_type=Shield, )
  overworld: (len=5, )
    [000]: (typ=GroundEquipment, actor=Weapon_Lsword_032, value=80000, modifier=none, )
    [001]: (typ=GroundEquipment, actor=Weapon_Bow_001, value=80000, modifier=none, )
    [002]: (typ=GroundEquipment, actor=Weapon_Bow_001, value=80000, modifier=none, )
    [003]: (typ=GroundEquipment, actor=Weapon_Shield_040, value=1000, modifier=none, )
    [004]: (typ=GroundEquipment, actor=Weapon_Shield_040, value=80000, modifier=none, )
  gdt: (weapons=8, bows=5, shields=4, )
    discovered_tabs: Sw,Bo,Sh,__,__,__,__
    items: (len=0, )
