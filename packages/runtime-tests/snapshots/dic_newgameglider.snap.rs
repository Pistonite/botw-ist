...
----- Step[1]: get 4 axe 4 simm 1 glider
...
game: (Running)
  ...
  pouch: (count=9, are_tabs_valid=true, num_tabs=3, holding_in_inventory=false, trial=false, )
    items: (len=9, )
      ...
      [008]: (actor_name=PlayerStole2, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=2, tab_slot=0, )
...
----- Step[3]: reload newgame

game: (Running)
  screen: (Overworld)
  pouch: (count=0, are_tabs_valid=true, num_tabs=2, holding_in_inventory=false, trial=false, )
    items: (len=3, )
      [000]: (actor_name=Item_Cook_B_02, value=1, is_equipped=false, item_type=Food, item_use=Item, tab_idx=0, tab_slot=0, )
        node: (valid=true, pos=413, addr=0x0000002222242fd8, prev=0x0000002222200068, next=0x0000002222242d40, )
        accessible: false
        dpad_accessible: false
      [001]: (actor_name=Item_Cook_B_02, value=1, is_equipped=false, item_type=Food, item_use=Item, tab_idx=0, tab_slot=1, )
        node: (valid=true, pos=412, addr=0x0000002222242d40, prev=0x0000002222242fd8, next=0x0000002222242aa8, )
        accessible: false
        dpad_accessible: false
      [002]: (actor_name=PlayerStole2, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=0, )
        node: (valid=true, pos=411, addr=0x0000002222242aa8, prev=0x0000002222242d40, next=0x0000002222200068, )
        accessible: false
        dpad_accessible: false
    tabs: (len=2, )
  ...
  pouch: (count=1, are_tabs_valid=true, num_tabs=2, holding_in_inventory=false, trial=false, )
    items: (len=4, )
      ...
      [001]: (actor_name=Item_Cook_B_02, value=1, is_equipped=false, item_type=Food, item_use=Item, tab_idx=0, tab_slot=1, )
        ...
        dpad_accessible: false
      [002]: (actor_name=PlayerStole2, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=0, )
        node: (valid=true, pos=411, addr=0x0000002222242aa8, prev=0x0000002222242d40, next=0x0000002222243270, )
      [003]: (actor_name=Obj_DRStone_Get, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=1, )
        node: (valid=true, pos=414, addr=0x0000002222243270, prev=0x0000002222242aa8, next=0x0000002222200068, )
    tabs: (len=2, )
      [00]: (item_idx=0, tab_type=Food, )
      [01]: (item_idx=2, tab_type=KeyItem, )
  gdt: (weapons=8, bows=5, shields=4, )
    ...
    items: (len=4, )
      [000]: (idx=0, actor=Item_Cook_B_02, value=1, is_equipped=false, )
        food: (idx=0, life_recover=0, duration=0, price=0, effect_id=-1, effect_level=0, )
      [001]: (idx=1, actor=Item_Cook_B_02, value=1, is_equipped=false, )
        food: (idx=1, life_recover=0, duration=0, price=0, effect_id=-1, effect_level=0, )
      [002]: (idx=2, actor=PlayerStole2, value=1, is_equipped=false, )
      [003]: (idx=3, actor=Obj_DRStone_Get, value=1, is_equipped=false, )

----- Step[5]: !remove all simm

game: (Running)
  screen: (Inventory)
  pouch: (count=-1, are_tabs_valid=true, num_tabs=1, holding_in_inventory=false, trial=false, )
    items: (len=2, )
      [000]: (actor_name=PlayerStole2, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=0, tab_slot=0, )
        node: (valid=true, pos=411, addr=0x0000002222242aa8, prev=0x0000002222200068, next=0x0000002222243270, )
      [001]: (actor_name=Obj_DRStone_Get, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=0, tab_slot=1, )
        node: (valid=true, pos=414, addr=0x0000002222243270, prev=0x0000002222242aa8, next=0x0000002222200068, )
    tabs: (len=1, )
...
game: (Running)
  ...
  pouch: (count=1, are_tabs_valid=true, num_tabs=4, holding_in_inventory=false, trial=false, )
    items: (len=4, )
      [000]: (actor_name=PlayerStole2, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=0, )
        node: (valid=true, pos=411, addr=0x0000002222242aa8, prev=0x0000002222200068, next=0x0000002222243270, )
      [001]: (actor_name=Obj_DRStone_Get, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=1, )
        node: (valid=true, pos=414, addr=0x0000002222243270, prev=0x0000002222242aa8, next=0x0000002222242d40, )
      [002]: (actor_name=Weapon_Lsword_032, value=4700, is_equipped=true, item_type=Sword, item_use=WeaponLargeSword, tab_idx=2, tab_slot=0, )
        node: (valid=true, pos=412, addr=0x0000002222242d40, prev=0x0000002222243270, next=0x0000002222242fd8, )
        dpad_accessible: false
      [003]: (actor_name=Weapon_Lsword_032, value=4700, is_equipped=false, item_type=Sword, item_use=WeaponLargeSword, tab_idx=2, tab_slot=1, )
        node: (valid=true, pos=413, addr=0x0000002222242fd8, prev=0x0000002222242d40, next=0x0000002222200068, )
        dpad_accessible: false
    tabs: (len=4, )
      [00]: (item_idx=-1, tab_type=Sword, )
      [01]: (item_idx=0, tab_type=KeyItem, )
      [02]: (item_idx=2, tab_type=Sword, )
  ...
  gdt: (weapons=8, bows=5, shields=4, )
    ...
    items: (len=4, )
      [000]: (idx=0, actor=PlayerStole2, value=1, is_equipped=false, )
...
game: (Running)
  ...
  pouch: (count=1, are_tabs_valid=true, num_tabs=4, holding_in_inventory=false, trial=false, )
    items: (len=4, )
      ...
      [001]: (actor_name=Obj_DRStone_Get, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=1, )
        node: (valid=true, pos=414, addr=0x0000002222243270, prev=0x0000002222242aa8, next=0x0000002222242d40, )
      [002]: (actor_name=Weapon_Lsword_032, value=0, is_equipped=false, item_type=Sword, item_use=WeaponLargeSword, tab_idx=2, tab_slot=0, )
        node: (valid=true, pos=412, addr=0x0000002222242d40, prev=0x0000002222243270, next=0x0000002222242fd8, )
        in_inventory: false
        dpad_accessible: false
      [003]: (actor_name=Weapon_Lsword_032, value=0, is_equipped=false, item_type=Sword, item_use=WeaponLargeSword, tab_idx=2, tab_slot=1, )
        node: (valid=true, pos=413, addr=0x0000002222242fd8, prev=0x0000002222242d40, next=0x0000002222200068, )
        in_inventory: false
        dpad_accessible: false
    tabs: (len=4, )
...
game: (Running)
  ...
  pouch: (count=2, are_tabs_valid=true, num_tabs=2, holding_in_inventory=false, trial=false, )
    items: (len=5, )
      [000]: (actor_name=Weapon_Lsword_032, value=4700, is_equipped=true, item_type=Sword, item_use=WeaponLargeSword, tab_idx=0, tab_slot=0, )
        node: (valid=true, pos=412, addr=0x0000002222242d40, prev=0x0000002222200068, next=0x0000002222243508, )
      [001]: (actor_name=Weapon_Lsword_032, value=4700, is_equipped=false, item_type=Sword, item_use=WeaponLargeSword, tab_idx=0, tab_slot=1, )
        node: (valid=true, pos=415, addr=0x0000002222243508, prev=0x0000002222242d40, next=0x0000002222242aa8, )
      [002]: (actor_name=PlayerStole2, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=0, )
        node: (valid=true, pos=411, addr=0x0000002222242aa8, prev=0x0000002222243508, next=0x0000002222243270, )
      [003]: (actor_name=Obj_DRStone_Get, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=1, )
        node: (valid=true, pos=414, addr=0x0000002222243270, prev=0x0000002222242aa8, next=0x0000002222242fd8, )
      [004]: (actor_name=PlayerStole2, value=1, is_equipped=false, item_type=KeyItem, item_use=ImportantItem, tab_idx=1, tab_slot=2, )
  ...
  gdt: (weapons=8, bows=5, shields=4, )
    discovered_tabs: Sw,__,__,__,__,__,Ki
    items: (len=4, )
      [000]: (idx=0, actor=PlayerStole2, value=4700, is_equipped=false, )
      [001]: (idx=1, actor=Obj_DRStone_Get, value=1, is_equipped=false, )
      [002]: (idx=2, actor=Weapon_Lsword_032, value=4700, is_equipped=true, )
        weapon: (idx=0, modifier=none, )
      [003]: (idx=3, actor=Weapon_Lsword_032, value=4700, is_equipped=false, )
