...
game: (Running)
  screen: (Overworld)
  pouch: (count=1, are_tabs_valid=true, num_tabs=1, holding_in_inventory=true, trial=false, )
    items: (len=1, )
...
game: (Running)
  screen: (Inventory)
  pouch: (count=2, are_tabs_valid=true, num_tabs=1, holding_in_inventory=true, trial=false, )
    items: (len=2, )
      [000]: (actor_name=Item_Mushroom_E, value=0, is_equipped=false, item_type=Material, item_use=CureItem, tab_idx=0, tab_slot=0, )
...
game: (Running)
  screen: (Inventory)
  pouch: (count=3, are_tabs_valid=true, num_tabs=1, holding_in_inventory=true, trial=false, )
    items: (len=3, )
      [000]: (actor_name=Item_Mushroom_E, value=0, is_equipped=false, item_type=Material, item_use=CureItem, tab_idx=0, tab_slot=0, )
        node: (valid=true, pos=419, addr=0x0000002222243f68, prev=0x0000002222200068, next=0x0000002222243cd0, )
        holding: 2
  ...
  gdt: (weapons=8, bows=5, shields=4, )
    ...
    items: (len=3, )
      [000]: (idx=0, actor=Item_Mushroom_E, value=2, is_equipped=false, )
      [001]: (idx=1, actor=Item_Fruit_A, value=1, is_equipped=false, )
      [002]: (idx=2, actor=Item_Fruit_I, value=1, is_equipped=false, )
