...
game: (Running)
  screen: (Overworld)
  pouch: (count=7, are_tabs_valid=true, num_tabs=7, holding_in_inventory=false, trial=false, )
    items: (len=7, )
...
game: (Running)
  screen: (Overworld)
  pouch: (count=-2, are_tabs_valid=false, num_tabs=0, holding_in_inventory=false, trial=false, )
    items: (len=23, )
      [000]: (actor_name=Weapon_Sword_043, value=800, is_equipped=true, item_type=Sword, item_use=WeaponSmallSword, tab_idx=0, tab_slot=0, )
        node: (valid=true, pos=419, addr=0x0000002222243f68, prev=0x0000002222200068, next=0x0000002222243cd0, )
        accessible: false
