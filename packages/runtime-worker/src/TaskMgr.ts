...
//         return this.state === TaskState.Running && this.nativeHandle.value;
//     }
//
...
//             console.warn(`cannot abort ${id}: already finished`);
...
//         if (ptr === undefined) {
//             console.warn(`${id} not aborting native: handle is undefined`);
//             return;
//         }
//         console.log(`[task] ${id} aborting native handle ${ptr}`)
...
//         // ensure if the task was aborted while assigning
//         // the native handle, we abort the native task
//         if (this.state as number === TaskState.Aborted) {
//             console.warn(`[task] task is immediately aborted while assigning native handle`);
//             const ptr = this.nativeHandle.take();
//             if (ptr !== undefined) {
//                 console.log(`[task] aborting native handle ${ptr}`)
//                 this.napi.abortTask(ptr);
//             }
//             return false;
//         }
...
//         if (!handle) {
//             console.warn(`cannot abort ${id}: never registered`);
...
//             console.warn(`deleting a handle with resource: ${id}, this will make the task not abortable.`);
//         }
...
//         console.log(`[task] ${id} native handle is ${nativeHandle.value}`)
//         if (handle.isAborted()) {
//             console.warn(`[task] task is immediately aborted while add ref`);
//             const ptr = nativeHandle.take();
//             if (ptr !== undefined) {
//                 console.log(`[task] aborting native handle ${ptr}`)
//                 this.napi.abortTask(ptr);
//             }
