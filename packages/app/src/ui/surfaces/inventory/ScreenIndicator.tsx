...
import { DesktopOff20Regular, PersonRunning20Regular, ShoppingBagPause20Regular } from "@fluentui/react-icons";
...
export const ScreenIndicator: React.FC<ScreenIndicatorProps> = ({screen}) => {
    ...
    return (
        ...
        >
            <Button
                icon={icon}
                appearance={(screenReal !== "none" && screenReal !== "overworld") ? "primary" : "transparent"}
            />
        </Tooltip>
    );
