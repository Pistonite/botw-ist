...
HEADER = """
/**
 * This file is generated by scripts/build-actor-data-map.py
 * DO NOT EDIT MANUALLY
 */
import type { ActorData } from "../data/default_actor_data.ts";
...
def main():
    ...
    output_path = os.path.join(OUTPUT_DIR, "actor_data_map.ts")
