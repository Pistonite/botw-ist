 ...
 */
export type InboundHook = (req: Request, url: URL) => Awaitable<Result<ResponsePayload | undefined, ResponsePayload>>;

export type Handler = (req: Request, url: URL) => Awaitable<ResponsePayload>;

export type OutboundHook = (req: Request, url: URL, ok: boolean, response: ResponsePayload) => Awaitable<ResponsePayload>;
