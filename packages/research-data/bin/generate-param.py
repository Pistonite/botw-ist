...
def main():
    ...
    print(f"collected data from {len(actor_data)} actors")

    output_path = os.path.join(os.path.dirname(home), "item-system", "src", "data", "ActorData.gen.ts")
    content = """
/**
