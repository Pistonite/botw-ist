...
export class _wxSenderImpl implements RuntimeApp {
    ...
    public crashApplication( ): WxPromise<void> {
        return this.sender.sendVoid(47 /* RuntimeApp.crashApplication */, [ ]);
    }
    ...
    public getCustomBlueFlameImage( ): WxPromise<Uint8Array | undefined> {
        return this.sender.send<Uint8Array | undefined>(48 /* RuntimeApp.getCustomBlueFlameImage */, [ ]);
    }
    ...
    public resolveQuotedItem( query: string ): WxPromise<ItemSearchResult | undefined> {
        return this.sender.send<ItemSearchResult | undefined>(49 /* RuntimeApp.resolveQuotedItem */, [ query ]);
    }
    ...
    public updatePerfData( data: PerformanceData ): WxPromise<void> {
        return this.sender.sendVoid(50 /* RuntimeApp.updatePerfData */, [ data ]);
    }
}
...
export const _wxRecverImpl = (handler: RuntimeApp): WxBusRecvHandler => {
    return ((fId, args: any[]) => { switch (fId) {
        case 47 /* RuntimeApp.crashApplication */: {
            return handler.crashApplication();
        }
        case 48 /* RuntimeApp.getCustomBlueFlameImage */: {
            return handler.getCustomBlueFlameImage();
        }
        case 49 /* RuntimeApp.resolveQuotedItem */: {
            const [ a0 ] = args;
            return handler.resolveQuotedItem( a0 );
        }
        case 50 /* RuntimeApp.updatePerfData */: {
            const [ a0 ] = args;
